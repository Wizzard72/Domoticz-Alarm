                ...
                if zoneModeTxt == "Armed Home":
                    if self.Matrix[row][2] == "Armed Home":
                        if self.Matrix[row][4] == "On":
                            ...
                            self.setAlarmArmingStatus("checkOpenSections", ArmingStatusUnit, "Open Sections")
